...
class Card {
  ...
  createCard(srcImg, altText, classNameImg, titleText, classNameTitle) {
    ...
    return this.addCardContent(card, srcImg, altText, classNameImg, classNameTitle, titleText);
  }
  ...
  addCardContent(card, srcImg, altText, classNameImg, classNameTitle, titleText) {
